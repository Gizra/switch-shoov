...
class FeatureContext extends MinkContext implements SnippetAcceptingContext {
   ...
   */
  public function iShouldSeeTheProductInComparisonList() {
    $this->iWaitForCssElement('.cart-val');
    $element = $this->getSession()->getPage()->find('css', '.cart-val');
    $this->getSession()->wait(3000);
    if ($element->getText() == 0) {
      throw new \Exception('0 products to compare');
    }
  }
